    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-muted-foreground animate-pulse">Calculating breakdown...</p>
        </div>
      </div>
    )
  }
        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-6">
            <div className="text-center">
              <div className="text-5xl font-bold text-primary">{currentAnalysis.readinessScore}%</div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-2 rounded bg-muted/50">
                  <div className="text-lg font-bold text-primary">{Math.round(currentAnalysis.explanation.coreCoverage)}%</div>
                  <div className="text-xs text-muted-foreground">Core Skills</div>
                </div>
                <div className="text-center p-2 rounded bg-muted/50">
                  <div className="text-lg font-bold text-accent">{Math.round(currentAnalysis.explanation.secondaryCoverage)}%</div>
          ...
          <div className="space-y-4">
            ...
            <div className="border-t border-border pt-4 mt-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-2xl font-bold text-primary">{currentAnalysis.readinessScore}%</span>
              </div>
            </div>
          </div>
        </CardContent>
