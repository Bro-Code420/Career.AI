...
RESUME FIT SCORE: ${currentAnalysis.resumeFitScore}/100
  ...
  const handleShare = async () => {
    const shareData = {
      ...
      text: `I just analyzed my readiness for ${currentAnalysis.roleSnapshot.title} on CareerAI! My score is ${currentAnalysis.readinessScore}%.`,
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="p-4 rounded-lg bg-muted/30">
              ...
              <p className="font-medium text-foreground">{currentAnalysis.resumeFitScore}/100</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-4 rounded-lg bg-muted/30">
              <div className="text-3xl font-bold text-primary">{currentAnalysis.readinessScore}%</div>
