  ...
  if (!currentAnalysis) {
    return (
      <div className="max-w-4xl mx-auto py-12 px-4">
        <Card className="border-border/50 bg-card/50 backdrop-blur-sm p-8 text-center space-y-6">
            ...
            {!currentAnalysis.resumeText ? (
              ...
              <>
                <div className="text-4xl font-bold text-foreground mb-2">
                  {currentAnalysis.resumeFitScore}
            ...
            <div className="space-y-3">
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="text-foreground font-medium">
                    {currentAnalysis.matchedSkills.length} skills
                  </span>
                </div>
                <Progress
              ...
              <div className="flex items-center gap-4 text-sm">
                <span className="flex items-center gap-1 text-success">
                  ...
                  {currentAnalysis.matchedSkills.length} matched
                </span>
